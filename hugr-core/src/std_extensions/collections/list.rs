...
mod test {
    ...
    #[case::insert_invalid(ListOp::insert, &[TestVal::List(vec![77,88,42]), TestVal::Idx(52), TestVal::Elem(99)], &[TestVal::List(vec![77,88,42]), TestVal::Err(type_row![Type::UNIT], vec![TestVal::Elem(99)])])]
