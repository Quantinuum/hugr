    ...
    ($arg:ident, $e:expr) => {
        delegate::delegate! {
            to ({let $arg=self; $e}) {
                ...
                fn mermaid_string_with_formatter(&self, #[into] formatter: crate::hugr::views::render::MermaidFormatter<Self>, render_label_config: crate::ops::RenderStringConfig) -> String;
